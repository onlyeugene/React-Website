...
const schema = yup
  .object({
    country: yup
      .string()
      .required(" please specify your country / region of residence"),
    email: yup
      .string()
    ...
    return (
      <div className="text-[12px] mb-[2rem]">
        <div className="flex items-center gap-2">
          <div>
            <img
              src={isLengthValid ? checkIcon : crossIcon}
              alt="icon of circle"
              className="w-[.5rem]"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <div>
            <img
              src={isUpperCaseValid ? checkIcon : crossIcon}
              alt="icon of circle"
              className="w-[.5rem]"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <div>
            <img
              src={isLowerCaseValid ? checkIcon : crossIcon}
              alt="icon of circle"
              className="w-[.5rem]"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <div>
            <img
              src={isNumberValid ? checkIcon : crossIcon}
              alt="icon of circle"
              className="w-[.5rem]"
            />
          </div>
          <p className={`${isNumberValid ? "text-green-500" : "text-red-500"}`}>
            At least one number
          </p>
        </div>
        <div className="flex items-center gap-2">
          <div>
            <img
              src={isSpecialCharValid ? checkIcon : crossIcon}
              alt="icon of circle"
              className="w-[.5rem]"
            />
          </div>
  ...
  return (
    <div>
      ...
      <div className='pt-[10rem] xl:text-center px-[1rem] xl:px-0'>
            <h1 className='xl:mr-[11.5rem] text-[28px] font-semibold pb-[1rem]'></h1>
          ...
          <div className="xl:text-start xl:ml-[7.5rem] ml-[.5rem]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="">
              <div>
                ...
                <label htmlFor="country" className="my-[2rem]">
                  {" "}
                ...
                <div className="relative">
                  <input
                    type="text"
                    className={`border rounded-md outline-none py-[.4rem] pr-[9.5rem] pl-2 mt-[.5rem] mb-[.5rem] ${
                  ...
                  <img
                    src={image3}
                    alt="icon of arrow down"
                    className="absolute top-5 w-[1rem] xl:right-[8em] right-[2rem]"
                  />
                  <p className="mb-[1rem] text-[12px] text-red-600">
              ...
              <div>
                ...
                <div>
                  <input
                    type="text"
                    className={`border rounded-md outline-none py-[.4rem] px-[4rem] pr-[9.5rem] pl-2 mt-[.5rem] mb-[.5rem] ${
                  ...
                  <img
                    src={image3}
                    alt="icon of arrow down"
                    className="absolute top-5 w-[1rem] right-[8em]"
                  />
                  <p className="mb-[1rem] text-[12px] text-red-600">
              ...
              <div>
                ...
                <div>
                  <div className="relative">
                    ...
                    <img
                      className="w-[1rem] absolute top-5 xl:right-[7.5rem] right-[2rem]"
              ...
              <input
                type="submit"
                value="Continue"
                className="border py-[.5rem] px-[8.5rem] bg-[#3dbeff] rounded-[.5rem] text-[16px] hover:bg-[#3dbeff] hover:text-white mb-[2rem]"
              />
            </form>
          </div>
        </div>
      ...
      <div className="xl:py-[4rem]">
        <div className="text-[10px] font-light xl:px-[10rem] px-[1rem]">
          <p className="pb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea facere
            excepturi perferendis dignissimos, tempore rem sunt optio eveniet
            sed quam. Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Nulla illum earum eligendi cupiditate, corrupti sunt laboriosam
            nihil placeat ullam quasi!
          </p>
          <p className="pb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum
            minus expedita, dignissimos odit iure asperiores ratione voluptatum
            eos quas porro dolores molestiae corporis, aperiam amet unde modi
            ipsam optio sint! Cumque eum beatae et commodi, quos placeat soluta,
            culpa repellat, necessitatibus atque quidem! Consequatur nostrum
            voluptatibus ipsam, illum ullam odio!
          </p>
          <p className="pb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita,
            sit eaque! Cum nihil hic praesentium aperiam quasi ratione delectus
            laboriosam ducimus ullam, quod dolores quam culpa quo commodi
            tempora quia. Eos ut eaque itaque ex ducimus ad cum, sit, maiores
            modi consequatur perspiciatis vitae eum, laboriosam dicta libero
            voluptates laudantium.
          </p>
          <p className="pb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam
            repellendus eaque praesentium rerum inventore quaerat tenetur,
            pariatur mollitia ad consequatur.
          </p>
          <p className="pb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita,
            perspiciatis!
          ...
          <p className="pb-[3rem]">
            ...
            repellat ea est perferendis culpa. Recusandae placeat quis
            exercitationem incidunt consequatur mollitia blanditiis quos
            perspiciatis fuga. Repudiandae tenetur cum perspiciatis deserunt
            velit id nobis quisquam, impedit voluptatum autem? Porro, nisi quam?
          </p>
        </div>
        <div className="border-t-[1px] border-gray-350 xl:w-[84.5rem]  w-[21rem] xl:ml-[10rem] ml-[1.5rem] xl:flex xl:justify-between text-[13px]">
          <div className="xl:flex gap-[3rem] pt-[1rem]">
            <p className="pb-1">Privacy Agreement</p>
            <p className="pb-1">Risk Disclosure</p>
            <p className="pb-1">Preventing Money Laundering</p>
            <p className="pb-1">Privacy Policy</p>
            <p className="pb-1">Sercurity instructions</p>
            <p className="pb-1">Legal Documents</p>
          </div>
          <div className="xl:pt-[1rem] xl:pb-0 pb-2">
